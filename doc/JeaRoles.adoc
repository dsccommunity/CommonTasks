...
:abstract:    {YmlCategory} defines Just Enough Administration (JEA) role capabilities specifying allowed commands and functions.
...
.See also
****
* xref:jeaendpoints.adoc[JeaEndpoints]
****
