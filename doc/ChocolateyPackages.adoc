...
:abstract:    {YmlCategory} installs and configures Chocolatey and manages software packages through the Chocolatey package manager.
...
****
Use this resource when you need to automate software installation via Chocolatey. It handles the full lifecycle: installing the Chocolatey client itself, configuring package sources and features, and installing software packages. Use this as the primary Chocolatey resource; use ChocolateyPackages2nd and ChocolateyPackages3rd for packages that have dependencies on packages installed in this resource.
****
...
| Key
| String
| The name of the Chocolatey source to manage.
|

| Ensure
|
| String
| Specifies whether the Chocolatey source should be present or absent.
| - *Present* (default)
  - Absent
...
.See also
****
* xref:chocolateypackages2nd.adoc[ChocolateyPackages2nd]
* xref:chocolateypackages3rd.adoc[ChocolateyPackages3rd]
****
