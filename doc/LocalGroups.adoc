...
:abstract:    {YmlCategory} manages local groups and their membership.
...
****
Use this resource when you need to create local groups or manage local group membership on target nodes. This is commonly used to add domain users or groups to the local Administrators group, or to create application-specific local groups for access control on standalone or domain-joined machines.
****
...
.See also
****
* xref:localusers.adoc[LocalUsers]
****
