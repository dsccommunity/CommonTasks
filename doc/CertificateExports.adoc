...
:abstract:    {YmlCategory} exports certificates from the Windows certificate store to files.
...
****
Use this resource when you need to export certificates (public keys, full certificate chains, or PFX files) from a Windows certificate store to the file system. This is useful for sharing certificates between servers, creating backups, or distributing trust anchors.
****
...
* xref:certificateimports.adoc[CertificateImports]
****
