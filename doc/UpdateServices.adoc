...
:abstract:    {YmlCategory} configures Windows Server Update Services (WSUS), including server setup, cleanup tasks, and approval rules.
...
****
Use this resource when you need to set up and configure a WSUS server for centralized Windows update management. It handles WSUS server initialization, product and classification selection, update languages, cleanup schedules, and automatic approval rules for your patch management strategy.
****
