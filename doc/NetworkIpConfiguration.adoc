...
:abstract:    {YmlCategory} provides comprehensive network IP configuration including interfaces, DNS, IP addresses, gateways, WINS, NetBIOS, routes, and IPv6 settings.
