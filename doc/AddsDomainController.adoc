...
****
Use this resource when you need to promote a Windows Server to a domain controller (DC) in an existing Active Directory domain. It supports both full (writable) DCs and Read-Only Domain Controllers (RODCs), global catalog configuration, and site assignment. Apply this after the domain has been created with the AddsDomain resource.
****
