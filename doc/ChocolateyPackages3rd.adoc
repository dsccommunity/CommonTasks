...
:abstract:    {YmlCategory} installs a third set of software packages using Chocolatey.

[#dscyml_chocolateypackages3rd]
= DSC Resource '{YmlCategory}'

[[dscyml_chocolateypackages3rd_abstract, {abstract}]]
{abstract}

.When to use '{YmlCategory}'
****
Use this resource when you have Chocolatey packages that depend on packages installed by ChocolateyPackages or ChocolateyPackages2nd. This provides a third ordering tier for complex dependency chains in your software deployment.
****
...
.See also
****
* xref:chocolateypackages.adoc[ChocolateyPackages]
