...
:abstract:    {YmlCategory} manages Replication Site Links within Active Directory.
...
****
Use this resource when you need to define or modify the AD replication topology by configuring site links. Site links control how domain controllers in different AD sites replicate directory data, including replication cost, frequency, and schedule. This is essential in multi-site AD deployments.
****
