...
:abstract:    {YmlCategory} configures the advanced Windows audit policy, including audit options, subcategories, and CSV-based policies.
...
****
Use this resource when you need to configure Windows security auditing to meet compliance requirements (e.g. CIS, STIG, PCI-DSS). It allows fine-grained control over which security events are audited, such as logon events, privilege use, object access, and policy changes.
****
