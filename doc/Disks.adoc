...
:abstract:    {YmlCategory} initializes, formats, and mounts disk partitions as drive letters.
...
****
Use this resource when you need to prepare raw disks for use by initializing them, creating partitions, formatting volumes, and assigning drive letters. This is essential for any server with additional data disks that need to be brought online and made available to the operating system.
****
...
.See also
****
* xref:diskaccesspaths.adoc[DiskAccessPaths]
****
