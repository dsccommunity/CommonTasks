...
:abstract:    {YmlCategory} creates and configures IIS websites with bindings, physical paths, and authentication settings.
...
****
Use this resource when you need to create IIS websites with specific bindings (ports, hostnames, SSL certificates), physical paths, and enabled protocols. Create the application pool first using WebApplicationPools. For web applications within a site, use WebApplications.
****
...
* xref:webapplications.adoc[WebApplications]
