...
:abstract:    {YmlCategory} configures Windows event log properties such as log size, retention, and security.
...
.See also
****
* xref:windowseventforwarding.adoc[WindowsEventForwarding]
****
