...
:abstract:    {YmlCategory} configures Windows Event Forwarding (WEF) collectors and subscriptions for centralized event log collection.
...
****
Use this resource when you need to set up centralized Windows event log collection. It configures a server as a WEF collector and creates subscriptions that pull specific events from source computers. This is essential for security monitoring, SIEM integration, and compliance logging across your infrastructure.
****
...
.See also
****
* xref:windowseventlogs.adoc[WindowsEventLogs]
****
