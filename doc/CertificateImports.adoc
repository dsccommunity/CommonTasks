...
:abstract:    {YmlCategory} imports certificates and PFX files into Windows certificate stores.
...
****
Use this resource when you need to deploy certificates to machines, such as importing SSL/TLS certificates for web servers, trusted root CA certificates, or intermediate CA certificates. Supports both standard certificate files and password-protected PFX files.
****
...
.See also
****
* xref:certificateauthorities.adoc[CertificateAuthorities]
* xref:certificaterequests.adoc[CertificateRequests]
* xref:certificateexports.adoc[CertificateExports]
****
