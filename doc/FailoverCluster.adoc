...
:abstract:    {YmlCategory} configures Windows Server Failover Clustering including cluster creation, quorum, shared disks, and network settings.
...
****
Use this resource when you need to set up a Windows Server Failover Cluster for high-availability workloads such as SQL Server Always On, Hyper-V, file servers, or other clustered roles. It handles cluster creation or joining, quorum configuration, cluster disks, network settings, and AD computer object prestaging.
****
