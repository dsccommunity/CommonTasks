...
| [[dscyml_addsdomainusers_computers, {YmlCategory}/Computers]]<<dscyml_addsdomainusers_computers_details, Computers>>
| 
| Hashtable[]
...
[[dscyml_addsdomainusers_computers_details]]
.Selected Attributes of category '<<dscyml_addsdomainusers_computers>>'
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
