...
| [[dscyml_filecontents_keyvaluepairfile, {YmlCategory}/KeyValuePairFiles]]<<dscyml_filecontents_keyvaluepairfile_details, KeyValuePairFiles>>
| hashtable[]
...
| [[dscyml_filecontents_replacetext, {YmlCategory}/ReplaceTexts]]<<dscyml_filecontents_replacetext_details, ReplaceTexts>>
| hashtable[]
...
.See also
****
* xref:filesandfolders.adoc[FilesAndFolders]
****
