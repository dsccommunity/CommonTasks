...
:abstract:    {YmlCategory} provides full deployment and configuration of a Microsoft DHCP Server, including scopes, exclusions, options, reservations, and server authorization.
...
****
Use this resource for complete DHCP server provisioning from scratch. It combines server authorization, scope creation, exclusion ranges, option values, and IP reservations into a single resource. If you only need to manage individual aspects (scopes, options), consider using the more targeted DhcpScopes, DhcpScopeOptions, DhcpServerOptions, or DhcpServerAuthorization resources instead.
****


// reference links as variables for using more than once
:ref_xDhcpServerScope:          https://github.com/dsccommunity/DhcpServerDsc/wiki/xDhcpServerScope[xDhcpServerScope]
:ref_DhcpServerExclusionRange:  https://github.com/dsccommunity/DhcpServerDsc/wiki/DhcpServerExclusionRange[DhcpServerExclusionRange]
:ref_xDhcpServerReservation:    https://github.com/dsccommunity/DhcpServerDsc/wiki/xDhcpServerReservation[xDhcpServerReservation]
:ref_DhcpServerOptionValue:     https://github.com/dsccommunity/DhcpServerDsc/wiki/DhcpServerOptionValue[DhcpServerOptionValue]
:ref_xDhcpServerAuthorization:  https://github.com/dsccommunity/DhcpServerDsc/wiki/xDhcpServerAuthorization[xDhcpServerAuthorization]
...
* xref:dhcpserverauthorization.adoc[DhcpServerAuthorization]
* xref:dhcpserveroptions.adoc[DhcpServerOptions]
* xref:dhcpserveroptiondefinitions.adoc[DhcpServerOptionDefinitions]
****
