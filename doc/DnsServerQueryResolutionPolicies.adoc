...
:abstract:    {YmlCategory} manages query resolution policies on a DNS server.
...
****
Use this resource when you need to control how a DNS server responds to queries based on criteria such as client subnet, query type, or time of day. DNS policies enable scenarios like split-brain DNS, geo-location-based responses, traffic management, and query filtering.
****
