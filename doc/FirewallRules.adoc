...
:abstract:    {YmlCategory} manages Windows Firewall rules on a node.
...
****
Use this resource when you need to create, modify, or remove individual Windows Firewall rules. It supports configuring inbound and outbound rules with specific ports, protocols, programs, services, remote addresses, and profiles. For configuring overall firewall profile settings (enable/disable, default actions), use FirewallProfiles instead.
****
...
.See also
****
* xref:firewallprofiles.adoc[FirewallProfiles]
****
