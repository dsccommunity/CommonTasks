// CommonTasks YAML Reference: AddsDomainAccounts
// ========================================

:YmlCategory: AddsDomainAccounts


[[dscyml_addsdomainaccounts, {YmlCategory}]]
= DSC Resource 'AddsDomainAccounts'
// didn't work in production: = DSC Resource '{YmlCategory}'


[[dscyml_addsdomainaccounts_abstract]]
...
|===
| Source         | https://github.com/dsccommunity/CommonTasks/tree/dev/CommonTasks/DscResources/AddsDomainAccounts
...
| [[dscyml_addsdomainaccounts_domaindn, DomainDn]]DomainDn
|
| String
| Distinguished Name (DN) of the domain.
|

| [[dscyml_addsdomainaccounts_computers, {YmlCategory}/Computers]]<<dscyml_addsdomainaccounts_computers_details, Computers>>
| 
| Hashtable[]
| List of computer accounts to create.
|

| [[dscyml_addsdomainaccounts_users, {YmlCategory}/Users]]<<dscyml_addsdomainaccounts_users_details, Users>>
| 
| Hashtable[]
| List of users to create.
|

| [[dscyml_addsdomainaccounts_kdskey, {YmlCategory}/KDSKey]]<<dscyml_addsdomainaccounts_kdskey_details, KDSKey>>
|
| Hashtable
...
| [[dscyml_addsdomainaccounts_managedserviceaccounts, {YmlCategory}/ManagedServiceAccounts]]<<dscyml_addsdomainaccounts_managedserviceaccounts_details, ManagedServiceAccounts>>
| 
| Hashtable[]
...
[[dscyml_addsdomainaccounts_computers_details]]
.Selected Attributes of category '<<dscyml_addsdomainaccounts_computers>>'
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
...
[[dscyml_addsdomainaccounts_users_details]]
.Selected Attributes of category '<<dscyml_addsdomainaccounts_users>>' - see {ref_ADUser} for more attributes
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
...
| Default: <<dscyml_addsdomainaccounts_domaindn>>
...
[[dscyml_addsdomainaccounts_kdskey_details]]
.Selected Attributes of category '<<dscyml_addsdomainaccounts_kdskey>>'
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
...
[[dscyml_addsdomainaccounts_managedserviceaccounts_details]]
.Selected Attributes of category '<<dscyml_addsdomainaccounts_managedserviceaccounts>>'
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
...
lookup_options:
  ...
  AddsDomainAccounts:
    merge_hash: deep
  AddsDomainAccounts\Computers:
    merge_hash_array: UniqueKeyValTuples
    merge_options:
      tuple_keys:
        - ComputerName
  AddsDomainAccounts\Users:
    merge_hash_array: UniqueKeyValTuples
    merge_options:
      tuple_keys:
        - UserName
  AddsDomainAccounts\ManagedServiceAccounts:
    merge_hash_array: UniqueKeyValTuples
    merge_options:
      tuple_keys:
        - ServiceAccountName
