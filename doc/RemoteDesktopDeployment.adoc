...
| [[dscyml_remotedesktopdeployment_gateways, {YmlCategory}/Gateways]]<<dscyml_remotedesktopdeployment_gateways_details, Gateways>>
|
| Hashtable[]
...
[[dscyml_remotedesktopdeployment_gateways_details]]
.Attributes of category '<<dscyml_remotedesktopdeployment_gateways>>'
[cols="1,1,1,2a,1a" options="header"]
|===
| Parameter
| Attribute
...
* xref:remotedesktophamode.adoc[RemoteDesktopHAMode]
