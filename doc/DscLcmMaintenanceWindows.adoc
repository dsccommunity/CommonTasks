...
:abstract:    {YmlCategory} defines maintenance windows during which DSC operates in ApplyAndAutoCorrect mode.
...
| [[dscyml_dsclcmmaintenancewindows_maintenancewindow, {YmlCategory}/MaintenanceWindows]]<<dscyml_dsclcmmaintenancewindows_maintenancewindow_details, MaintenanceWindows>>
| Mandatory
| Hashtable[]
