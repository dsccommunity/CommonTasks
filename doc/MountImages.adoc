...
:abstract:    {YmlCategory} mounts or unmounts ISO and VHD disk images and waits for their volumes to become available.
...
****
Use this resource when you need to mount ISO or VHD files during a DSC configuration, for example to access installation media for software deployments. It ensures the mounted volume is available before dependent resources attempt to access the files on it.
****
...
.See also
****
* xref:opticaldiskdrives.adoc[OpticalDiskDrives]
****
